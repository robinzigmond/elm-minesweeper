...
var author$project$Main$sub = function (_n0) {
...
var author$project$Game$startGrid = F2(
...
var author$project$Logic$countPossibleMines = function (g) {
	return A3(
		...
		A2(
			...
			A2(
				...
				elm$core$Array$filter(
					function (a) {
						return _Utils_eq(a, author$project$Types$Unknown) || _Utils_eq(a, author$project$Types$KnownMine);
					}),
...
var author$project$Logic$insert = F3(
	function (_n0, a, grid) {
		var x = _n0.a;
		var y = _n0.b;
...
var author$project$Logic$lookup = F2(
	function (grid, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		var _n1 = A2(elm$core$Array$get, y, grid);
...
var author$project$Logic$reveal = F2(
	function (grid, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		var _n1 = A2(elm$core$Array$get, y, grid);
...
var author$project$Logic$neighbours = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	return _List_fromArray(
		[
...
var author$project$Logic$countNeighbours = F2(
	function (grid, _n0) {
		var x = _n0.a;
		var y = _n0.b;
		return elm$core$List$length(
			A2(
				...
				A2(
					elm$core$List$map,
					author$project$Logic$reveal(grid),
...
var author$project$Logic$uncoverMany = F3(
	function (grid, found, _n0) {
		...
		if (_Utils_eq(
			A2(
				...
				found,
				_Utils_Tuple2(x, y)),
			elm$core$Maybe$Just(author$project$Types$Unknown))) {
			var _n1 = A2(
				...
				if (_n1.a.$ === 'Mine') {
					...
					var go = F2(
						function (next, cum) {
							go:
							while (true) {
								if (elm$core$List$isEmpty(next)) {
									return cum;
								} else {
									var newNeighbours = A2(
										elm$core$List$filter,
										function (pos) {
											return _Utils_eq(
										...
										A2(
											...
											A2(
												elm$core$List$filter,
												function (pos) {
													return !A2(author$project$Logic$countNeighbours, grid, pos);
												},
												next)));
									var $temp$next = newNeighbours,
										$temp$cum = elm$core$Set$toList(
			...
			if (_n1.a.$ === 'Mine') {
				...
				if (_n3.$ === 'Nothing') {
					...
					return A3(
						...
						_Utils_Tuple2(x, y),
						author$project$Types$KnownMine,
						found);
				}
			} else {
				var _n4 = _n1.a;
				var _n5 = A2(
					author$project$Logic$countNeighbours,
					grid,
					_Utils_Tuple2(x, y));
				if (!_n5) {
					return A3(
						...
						F2(
							function (_n6, gr) {
								...
								return A3(
									author$project$Logic$insert,
									_Utils_Tuple2(x0, y0),
									author$project$Types$Neighbours(
										A2(
											author$project$Logic$countNeighbours,
											grid,
											_Utils_Tuple2(x0, y0))),
						...
						found,
						A3(
							author$project$Logic$uncoverMany,
							grid,
							found,
							_Utils_Tuple2(x, y)));
				} else {
					...
					return A3(
						author$project$Logic$insert,
						_Utils_Tuple2(x, y),
						author$project$Types$Neighbours(n),
						found);
				}
			}
		}
...
var author$project$RandomGrid$randomGrid = F3(
	function (width, height, numMines) {
		var split = F2(
			function (status, arrs) {
				var _n0 = elm$core$Array$length(arrs);
				if (!_n0) {
					return elm$core$Array$fromList(
						_List_fromArray(
							[
					...
					if (_n1.$ === 'Nothing') {
						...
						var lastArr = _n1.a;
						var _n2 = elm$core$Array$length(lastArr);
						var w = _n2;
						if (_Utils_eq(w, width)) {
							return A2(
								elm$core$Array$push,
								elm$core$Array$fromList(
									_List_fromArray(
							...
							var update = F2(
								function (i, arr) {
									return _Utils_eq(i, len - 1) ? A2(elm$core$Array$push, status, arr) : arr;
								});
							return A2(elm$core$Array$indexedMap, update, arrs);
						}
					}
				}
			});
			...
			case 'Click':
				...
				return redo ? _Utils_Tuple2(
					...
					A2(
						...
						A4(
							author$project$RandomGrid$repeatUntilSafe,
							_Utils_Tuple2(x, y),
							width,
							height,
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'InGame') {
			...
			var inputMsg = msg.a;
			return A2(author$project$Main$updateInput, inputMsg, model);
		}
	});
...
var author$project$Game$onRightClick = function (message) {
	return A2(
...
var author$project$Game$viewCell = F3(
	function (playing, _n0, stat) {
		var x = _n0.a;
		var y = _n0.b;
		...
		var actions = playing ? _List_fromArray(
			[
				elm$html$Html$Events$onClick(
				A2(author$project$Game$Click, x, y)),
				author$project$Game$onRightClick(
				A2(author$project$Game$ToggleMine, x, y))
			]) : _List_Nil;
		return A2(
			elm$html$Html$div,
			A2(
				elm$core$List$cons,
				elm$html$Html$Attributes$class('cell' + otherClass),
				actions),
			content(stat));
	});
var author$project$Game$viewRow = F4(
	function (playing, width, y, cells) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
...
var author$project$Logic$countKnownMines = function (g) {
	return A3(
		elm$core$Array$foldl,
		elm$core$Basics$add,
		0,
		A2(
			...
			A2(
				...
				elm$core$Array$filter(
					function (a) {
						return _Utils_eq(a, author$project$Types$KnownMine);
					}),
				elm$core$Array$length),
			g));
};
...
var author$project$Game$viewGame = function (model) {
	var winMessage = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('notice win')
			]),
		_List_fromArray(
			[
				elm$html$Html$text('Well done, you uncovered everything but the mines!')
			]));
	var newGameButton = A2(
		elm$html$Html$button,
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(author$project$Game$NewGame),
				elm$html$Html$Attributes$class('main-button')
			]),
		_List_fromArray(
			[
	...
	var mineCounter = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('mines-remaining')
			]),
		_List_fromArray(
			[
				elm$html$Html$text('Mines Remaining '),
				A2(
				elm$html$Html$span,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('mine-count')
					]),
				A2(
					elm$core$List$map,
					function (c) {
	...
	var grid = A2(
		...
		function (l) {
			return A2(elm$core$List$cons, mineCounter, l);
		}(
			elm$core$Array$toList(
				A2(
					elm$core$Array$indexedMap,
	...
	var failureMessage = A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('notice failure')
			]),
		_List_fromArray(
			[
	...
	function (field, val, maybeErr) {
		...
		var errElements = function () {
			if (maybeErr.$ === 'Nothing') {
				...
				var errField = _n1.a;
				var errMsg = _n1.b;
				return _Utils_eq(errField, field) ? _List_fromArray(
					[
						A2(
						elm$html$Html$div,
						_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('single-option')
				]),
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('input-btn'),
										elm$html$Html$Events$onClick(
										author$project$Main$Decrement(field))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('-')
								...
								_List_fromArray(
									[
										...
										author$project$Main$CheckMaxMin(field)),
										elm$html$Html$Events$onInput(
										A2(
											elm$core$Basics$composeL,
											A2(
												elm$core$Basics$composeL,
												author$project$Main$New(field),
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('input-btn'),
										elm$html$Html$Events$onClick(
										author$project$Main$Increment(field))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('+')
...
var author$project$Main$viewInput = F4(
	function (width, height, numMines, maybeErr) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('game-options')
				]),
			_Utils_ap(
				A2(
					elm$core$List$cons,
					A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('Game Options')
							])),
					A2(
						elm$core$List$map,
						function (_n0) {
							var field = _n0.a;
							var val = _n0.b;
							return A3(author$project$Main$viewField, field, val, maybeErr);
						},
						_List_fromArray(
							[
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('inner-wrapper')
			]),
		A2(
			elm$core$List$cons,
			function () {
			...
			_Utils_eq(model.gameState, elm$core$Maybe$Nothing) ? _List_Nil : _List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(
							author$project$Main$Input(author$project$Main$Menu)),
							elm$html$Html$Attributes$class('main-button')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('Change game options')
						]))
				])));
};
